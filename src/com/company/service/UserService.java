...
public abstract interface UserService {
	 public abstract List<Map<String , Object>> getAllUser();
	  public abstract void article(@PathParam("title") String title,@PathParam("content") String content,@Param("date") String date,@Param("article_img") String article_img);
